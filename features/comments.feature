Feature: Manage WordPress comments
  ...
  Scenario: Leave a comment logged-out
    ...
    And I should see "One response to “Hello world!”" in the "h3.wp-block-comments-title" element
  ...
  Scenario: Leave a comment logged-in
    ...
    And I press "submit"
    Then print current URL
    And I should see "2 responses to “Hello world!”" in the "h3.wp-block-comments-title" element
